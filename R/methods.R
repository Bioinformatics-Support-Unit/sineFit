...
sineFit.sf = function(in_data, rowData, min_per = 24, max_per = 24){
...
setGeneric("sineFit", def = sineFit.sf)
setMethod("sineFit", signature(in_data = "data.frame", rowData = "data.frame"), sineFit.sf)
